...
public class Book implements I_Default, I_SimpleInterface{  // Имплементация нескольких интерфейсов, I_SimpleInterface - простой интерфейс
    ...
    public void displayInfo() {
        ...
        // GetOwnerBook() - дефолтный метод из интерфейса
        System.out.printf("Название: %s, Автор: %s, Доступность: %s, Владелец: %s\n", title, author, answer.get(available), GetOwnerBook()); 
    }
